...
<body>
	<div class="container-fluid2"> 
		...
		<!-- Brand and toggle get grouped for better mobile display -->
				...
				<div class="collapse navbar-collapse" id="navbar-collapse-2">
				  <ul class="nav navbar-nav navbar-right">
					...
					<li><a href="all.jsp">All Tabs</a></li>
					<c:choose>
		...
		<div class="bodytab">
		<h1> Welcome, <c:out value="${information[0]}"/>!</h1>
		</div>
		<div class="upstep1"> <h1> Edit Profile </h1> </div>
		<div class="uploadcont">
		<form id ="upload" role ="form" class="form-inline">
		<div class="form-group" id="formblack">
						<label for="title" >Username</label>
						<input value='' id="title" placeholder="Username" 
							type="text" class="form-control" />
					</div>
					<div class="form-group">
						<label for="artist">Password</label>
						<input id="artist" value='' placeholder="" 
							type="password" class="form-control" />
					</div>	
		</form>
		<button type="button" class="btn btn-success" action="submit" 
			form="upload">Save</button>
		</div>
